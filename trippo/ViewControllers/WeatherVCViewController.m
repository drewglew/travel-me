...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.ImageIcon setImage:[UIImage imageNamed:item.icon]];
    ...
    if (doHighlight) {
        [cell.contentView setBackgroundColor:[UIColor colorWithRed:0.0f/255.0f green:102.0f/255.0f blue:51.0f/255.0f alpha:1.0]];
        [cell.LabelTemp setTextColor:[UIColor whiteColor]];
        [cell.LabelSummary setTextColor:[UIColor whiteColor]];
        [cell.LabelTime setTextColor:[UIColor whiteColor]];
        
    } else {
        [cell.contentView setBackgroundColor:[UIColor clearColor]];
        [cell.LabelTemp setTextColor:[UIColor blackColor]];
        [cell.LabelSummary setTextColor:[UIColor blackColor]];
        [cell.LabelTime setTextColor:[UIColor blackColor]];
    }
